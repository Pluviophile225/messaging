...
import (
	...
	redisMocks "messaging/pkg/internal/redis/mocks"
...
func TestNewClientWithCreator(t *testing.T) {
	tests := []struct {
		...
		pemDecoder       internal.PEMDecoder
		wantErr          bool
	}{
		{
...
func TestClient_Publish(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			topic:              "",
			wantErr:            true,
			errorType:          internal.InvalidTopicErr{},
		},
		{
			...
			topic:              Topic,
			wantErr:            true,
			errorType:          internal.MissingConfigurationErr{},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
